...
export class SubMainThreadCom extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.message = { "id": 16777222, "type": 10003, params: [], "bundleName": "com.example.nativecase", "moduleName": "entry" };
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                ...
                Blank.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Button.createWithLabel({ "id": 16777233, "type": 10003, params: [], "bundleName": "com.example.nativecase", "moduleName": "entry" });
                    Button.width('100%');
                    Button.onClick(() => {
                        testNapi.threadSafeCaseFun(this.work);
                        this.getUIContext().getPromptAction().showToast({
                            message: { "id": 16777232, "type": 10003, params: [], "bundleName": "com.example.nativecase", "moduleName": "entry" },
                            duration: 2000
                        });
                    });
                }, Button);
                Button.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Button.createWithLabel({ "id": 16777223, "type": 10003, params: [], "bundleName": "com.example.nativecase", "moduleName": "entry" });
                    Button.width('100%');
                    Button.margin({ top: 12 });
                    Button.onClick(() => {
                        testNapi.libUvCaseFun(this.work);
                        this.getUIContext().getPromptAction().showToast({
                            message: { "id": 16777224, "type": 10003, params: [], "bundleName": "com.example.nativecase", "moduleName": "entry" },
                            duration: 2000
                        });
                    });
                }, Button);
            ...
            NavDestination.title({ builder: () => {
                    TitleComponent.call(this, { "id": 16777230, "type": 10003, params: [], "bundleName": "com.example.nativecase", "moduleName": "entry" }, { "id": 16777231, "type": 10003, params: [], "bundleName": "com.example.nativecase", "moduleName": "entry" });
                } });
        }, NavDestination);
        NavDestination.pop();
    }
